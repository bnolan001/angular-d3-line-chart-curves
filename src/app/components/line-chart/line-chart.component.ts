...
export class LineChartComponent implements OnInit {
  ...
  /**
   * Create circle markers to help visualize the data points
   */
  ...
  /**
   * Apply different curve algorithms based on the configured value for this
   * graph
   */
  private applyCurve() {
    console.log(`LineChartComponent:applyCurve: '${this.linecurvestyle}'`);
    switch (this.linecurvestyle.toLowerCase()) {
      case "curvecatmullrom":
        this.line.curve(d3.curveCatmullRom);
        break;
      case "curvecatmullromopen":
        this.line.curve(d3.curveCatmullRomOpen);
        break;
      case "curvecatmullromclosed":
        this.line.curve(d3.curveCatmullRomClosed);
        break;
      case "curvecardinal":
        this.line.curve(d3.curveCardinal);
        break;
      case "curvecardinalopen":
        this.line.curve(d3.curveCardinalOpen);
        break;
      case "curvecardinalclosed":
        this.line.curve(d3.curveCardinalClosed);
        break;
      case "curvebasis":
        this.line.curve(d3.curveBasis);
        break;
      case "curvebasisclosed":
        this.line.curve(d3.curveBasisClosed);
        break;
      case "curvebasisopen":
        this.line.curve(d3.curveBasisOpen);
        break;
      case "curvebundle":
        this.line.curve(d3.curveBundle);
        break;
      case "curvelinear":
        // same as the default curve
        this.line.curve(d3.curveLinear);
        break;
      case "curvelinearclosed":
        this.line.curve(d3.curveLinearClosed);
        break;
      case "curvenatural":
        this.line.curve(d3.curveNatural);
        break;
      case "curvestep":
      ...
      case "curvestepbefore":
        this.line.curve(d3.curveStepBefore);
        break;
      case "curvemonotonex":
        this.line.curve(d3.curveMonotoneX);
        break;
      case "curvemonotoney":
        this.line.curve(d3.curveMonotoneY);
        break;
      default:
        break;
    }
